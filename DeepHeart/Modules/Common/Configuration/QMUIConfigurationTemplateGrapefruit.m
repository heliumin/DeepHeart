...
- (void)applyConfigurationTemplate {
    ...
    QMUICMI.navBarBackgroundImage = [DHUIHelper navigationBarBackgroundImageWithThemeColor:UIColor.dh_tintColor];
}
...
- (BOOL)shouldApplyTemplateAutomatically {
    ...
    NSString *selectedThemeIdentifier = [[NSUserDefaults standardUserDefaults] stringForKey:DHSelectedThemeIdentifier];
...
- (NSString *)themeName {
    return DHThemeIdentifierGrapefruit;
}
